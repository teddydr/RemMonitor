    ...
    public class Program
    {
        ...
        public static void Run_Consume(string brokerList, List<string> topics)
        {
            ...
            using (var consumer = new Consumer<Ignore, string>(constructConfig(brokerList, false), null, new StringDeserializer(Encoding.UTF8)))
            {
                ...
                */
                ...
                while (!cancelled)
                {
                    /*Console.WriteLine("press any key to consume");
                    Console.ReadLine();*/
                    ...
                    Console.WriteLine($"Topic: {msg.Topic} Partition: {msg.Partition} Offset: {msg.Offset} {msg.Value}");
                    db.LogsDB.Add(new LogDB { TopicName = msg.Topic, DateStamp = DateTime.Now });
                    var count3 = db.SaveChanges();
                    Console.WriteLine("{0} records saved to database", count3);
        ...
        public static void Main(string[] args)
        {
            ...
            */
            ...
            Console.Write("Broker address: ");
            string brokerList = Console.ReadLine();
